...
## Environments
- Preview: https://main--test-forms-edge-services--insideaem.hlx.page/
- Live: https://main--test-forms-edge-services--insideaem.hlx.live/
...
1. Open the `test-forms-edge-services` directory in your favorite IDE and start coding :)
